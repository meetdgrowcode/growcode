...
export default function ApplyForm() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-12 sm:px-6 lg:px-8">
      ...
      {/* FORM CONTAINER */}
      <div className="mx-auto w-full max-w-2xl rounded-xl bg-white p-8 shadow-sm border border-gray-100 animate-fade-in-up">
          ...
          <>
            ...
            <form onSubmit={submitForm} className="mt-8 space-y-5">
              ...
              <div>
                ...
                <Input required placeholder="Enter your full name" className="mt-1" />
              </div>

              {/* Email */}
              <div>
                <label className="text-sm font-medium text-gray-700">Email Address</label>
                <Input type="email" required placeholder="your@email.com" className="mt-1" />
              </div>

              {/* Phone Number */}
              <div>
                <label className="text-sm font-medium text-gray-700">Phone Number</label>
                <Input required placeholder="9876543210" className="mt-1" />
              </div>

              {/* Portfolio/GitHub */}
              <div>
                <label className="text-sm font-medium text-gray-700">Portfolio / GitHub (optional)</label>
                <Input placeholder="https://your-portfolio.com" className="mt-1" />
              </div>
              ...
              <div>
                ...
                <div className="mt-2 flex items-center gap-3 rounded-lg border border-gray-200 bg-gray-50 p-3">
                  <label
                    htmlFor="resume"
                    className="flex cursor-pointer items-center gap-2 rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 transition shadow-sm"
                  >
                ...
                <p className="mt-1 text-xs text-gray-500">Accepted formats: PDF, DOC, DOCX</p>
                  ...
                  <Button
                    type="submit"
                    className="w-full rounded-full bg-blue-600 py-2 text-white hover:bg-blue-700 transition shadow-lg shadow-blue-200"
                  >
                    Submit Application
                  </Button>
                </form>
