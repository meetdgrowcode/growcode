      ...
      <div className="mx-auto w-full max-w-screen p-4 py-6 lg:py-8">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            {footerLinks.map((section, index) => (
              <div key={index}>
                <h2 className="mb-6 text-sm font-semibold text-slate-900 uppercase">
                  {section.title}
                </h2>
                ...
                <ul className="text-slate-600 font-medium">
                  {section.links.map((link, i) => (
                    <li key={i} className="mb-4">
                      <a href={link.url} className="hover:underline hover:text-blue-600 transition-colors">
                        {link.name}
                      </a>
                    </li>
                  ))}
          ...
          <div className="flex gap-6 mt-4 sm:justify-center sm:mt-0">
            ...
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.551 0-2.334.803-2.334 2.226v6.38h-3.554V9h3.554v1.516c0 .033.003.065.008.098.508-1.558 2.052-2.748 4.237-2.748 3.033 0 4.542 1.954 4.542 5.099v7.487zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452z" />
              </svg>
            </a>
